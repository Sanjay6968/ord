...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, TextField, MenuItem, Select, FormControl, InputLabel, Box, SelectChangeEvent, Typography } from '@mui/material';
    ...
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="lg">
      ...
      <DialogContent>
        ...
        <Box mt={2}>
          ...
          <FormControl fullWidth margin="dense" variant="outlined">
            <InputLabel>Expert Assistance</InputLabel>
            <Select
              value={orderData.expert_assistance}
              onChange={handleSelectChange}
